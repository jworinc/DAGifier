...
- Profiles: `dev`
- Open lifecycle findings: `1`

## Open Findings

| severity | area | rule_id | finding |
|---|---|---|---|
| high | governance.declaration | inference.missing_manifest | Lifecycle manifest missing; inferred_state_candidate=active_dev. |
